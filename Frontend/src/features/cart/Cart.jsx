        ...
        <section className='min-h-screen bg-black text-white'>
            <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-36 pt-24 pb-16'>
                <div className='py-4 w-full'>
                    ...
                    <p className='text-sm sm:text-base text-gray-400'>3 items in your cart</p>
                </div>
                    ...
                    <div className='w-full lg:w-2/3 bg-black border border-gray-700/70 rounded-xl shadow-2xl overflow-hidden h-[50vh]'>
                        ...
                        <div className='flex flex-col sm:flex-row justify-between items-center gap-4 p-4 border-b border-gray-700/70'>
                            ...
                            <div className='flex flex-col text-center sm:text-left'>
                                <span className='text-sm font-bold'>Premium Wireless Headphones</span>
                                <span className='text-xs'>Audio</span>
                                <span className='text-sm font-bold'>$299.99</span>
                            </div>
                            ...
                            <div className='flex flex-col gap-1 items-center justify-center'>
                                <div>$299.99</div>
                                <button className='flex justify-center items-center bg-[#0d0d0d] bg-opacity-[12%] px-2 rounded-xl font-bold text-sm gap-2 transition-all duration-500 ease-in-out hover:bg-slate-400/20'>
