        ...
        <section className='min-h-screen bg-black text-white'>
            <div className='py-24 container m-auto items-center'>
                ...
                <div className='flex flex-wrap gap-10 overflow-hidden h-fit justify-center items-center myContainer mx-auto px-4 md:px-10 lg:px-32 py-8 mt-8 '>
                    {products.map((p) => (
                        <div key={p._id} className='w-[320px] bg-black border border-gray-400/20 rounded-xl group overflow-hidden' onClick={() => {
                            ...
                            <div className='flex flex-col gap-5 p-7 '>
                                ...
                                <div className='flex items-center gap-2'>
                                    <span className='text-xl font-bold'>${p.offerPrice}</span>
                                    <span className='text-base font-bold line-through text-gray-500'>${p.price}</span>
