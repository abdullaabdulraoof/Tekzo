                ...
                <div className='flex flex-wrap gap-10 overflow-hidden h-fit justify-center items-center myContainer mx-auto px-4 md:px-10 lg:px-32 py-8 mt-8 '>
                    ...
                    <div className='w-[320px] bg-black border border-gray-400/20 rounded-xl group overflow-hidden'>
                        <div className='relative h-[300px] overflow-hidden' onClick={() => {
                            ...
                            <img src="/src/User/assets/laptop.jpg" alt="Headset"
                        ...
                        <div className='flex flex-col gap-2 p-7 '>
                            <span className='text-sm'>Apple.Inc</span>
                            <span className='text-lg font-bold' >MacBook Pro 16"</span>
                            <div className='flex items-end gap-3 '>
                                <span className='text-xl font-bold'>₹80000</span>
                                <span className='text-base text-gray-500 line-through'>M.R.P: ₹120000</span>
