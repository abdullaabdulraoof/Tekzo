                ...
                <div className='flex flex-wrap gap-10 overflow-hidden  h-fit justify-center items-center myContainer mx-auto px-5 md:px-10 lg:px-60 py-2 '>
                    ...
                    <div className="flex justify-start gap-2 w-full px-2 overflow-x-scroll h-500px py-3">
                        ...
                        (<div key={index} onClick={()=>{
                            ...
                            <div className="relative rounded-xl bg-cover bg-center  transform translate-all duration-500 ease-in-out hover:shadow-[0_0_12px_#5694F7] hover:scale-x-105 h-[250px] w-[200px]" style={{
                                backgroundImage: `url("http://localhost:3000/${pro.images[0].replace(/\\/g, "/")}")`
                            }}>

                                <div className='absolute bg-gray-900/60 bottom-0 w-full h-[35px] text-center py-2 font-bold rounded-b-xl '>{pro.name}</div>
                            </div>
                        </div>
