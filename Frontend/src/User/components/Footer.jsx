...
export const Footer = () => {
    return (
        <footer>
            <div className='bg-black text-white border-t border-gray-600/30 w-full flex-col justify-between items-center mx-auto px-4 md:px-10 lg:px-60 lg:flex py-8'>
